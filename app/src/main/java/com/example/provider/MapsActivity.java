...
import static com.example.provider.Current.current_Request;
    ...
    private void displayLocation() {
        ...
        if(ActivityCompat.checkSelfPermission(this , Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if(mLastLocation != null){
                ...
                drawRoute(myLocation , current_Request.getAddress() , current_Request.getReqno());
            }
        }
    }
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    class ParseTask extends AsyncTask<String , Integer , List<List<HashMap<String,String>>>> {
